...
class test_models(TestCase):
    ...
    def setUp(self):
        ...
        self._actividad_tiempo_real.create_actividad_tiempo_real("entrenar", "entrenar Voleibol", "deporte",
                                                               "2019.10.10 14:30", self._persona_natural_1)
        self._actividad_a_posteriori.create_actividad_a_posteriori("jugar", "jugar Catan", "sacar la vuelta",
                                                                 "2019.10.10 10:00", 60, self._persona_natural_1)
